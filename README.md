...
A modern Android application that tracks win, pick and ban rates of heroes across multiple game
modes and ranks in Arena of Valor (AoV) using Jetpack Compose and Kotlin.
